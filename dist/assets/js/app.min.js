...
(function(){$(function(){$("a[href*=#]:not([href=#])").click(function(){var t;return location.pathname.replace(/^\//,"")===this.pathname.replace(/^\//,"")&&location.hostname===this.hostname&&(t=$(this.hash),t=t.length?t:$("[name="+this.hash.slice(1)+"]"),t.length)?($("html,body").animate({scrollTop:t.offset().top},1e3),!1):void 0})})}).call(this);
(function(){var t;t=Math.max(document.documentElement.clientWidth,window.innerWidth||0),t>1200&&(new WOW).init()}).call(this);
